...
void SoftwareSerial::setRX(uint8_t rx)
{
  _receivePin = rx;
  _receiveBitMask = 0;
  _receivePortRegister = NULL;
  _pcint_maskreg = NULL;
  _pcint_maskvalue = 0;
  if (digitalPinToPCICR((int8_t)rx) == NULL)
    return;
...
void SoftwareSerial::begin(long speed)
{
  ...
  if (_receivePortRegister != NULL && _receiveBitMask != 0 && digitalPinToPCICR((int8_t)_receivePin)) {
